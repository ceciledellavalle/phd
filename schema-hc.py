...
######################  EULER IMPLICIT CENTERED SCHEME  ########################################
...
### PHYSICAL PARAMETERS
a = 0.001*np.ones(NX) # Polymerisation speed
a[NX-1] = 0
...
alpha = NX/L*NT/T
propc = 0.0001 # Proportion of monomers in the system
...
state[0,0] = propc*moment[1:].dot(state[1:,0])
...
ax_state = plt.axes(xlim=(0, L), ylim=(0, 10))
